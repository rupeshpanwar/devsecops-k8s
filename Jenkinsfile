pipeline {
  ...
  stages {
      ...
      stage('SonarQube - SAST') {
          steps {
            sh "mvn sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.host.url=http://142.93.213.194:9000 -Dsonarlogin=6a993da4fd9a411c2a96ba2bab03dc0f26e6a105"
          }
